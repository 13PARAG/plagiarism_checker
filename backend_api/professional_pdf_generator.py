# """
# PROFESSIONAL PLAGIARISM REPORT GENERATOR (Academic Standard Format)
# File: backend_api/professional_pdf_generator.py

# Generates professional academic plagiarism reports with:
# - Cover page (like your institution's format)
# - Color-coded highlighting (Red/Yellow/Green based on similarity)
# - Text highlighting with source references
...
#     """
#     Add HTML color tags to text based on similarity score
    
#     Color scheme (like Turnitin):
#     - Red: 75-100% (High plagiarism)
#     - Orange: 50-74% (Medium-High)
#     - Yellow: 25-49% (Medium)
#     - Green: 1-24% (Low)
#     - Blue: 0% (No plagiarism)
#     """
...
#     """
#     Generate professional academic plagiarism report (like institutional format)
...
#             elements.append(Paragraph(original_highlighted, normal_style))
#             elements.append(Spacer(1, 0.15*inch))
            
#             # Page break before submission text for better layout
...
#             elements.append(Paragraph(submission_highlighted, normal_style))
...
#             # Color based on highest similarity
#             if highest_sim >= 0.75:
#                 verdict_color = colors.HexColor('#F44336')
...
#                 # Color coding for source matches
#                 if match_sim >= 75:
#                     source_color = colors.HexColor('#FFCCCC')  # Light red
#                 elif match_sim >= 50:
#                     source_color = colors.HexColor('#FFE0B2')  # Light orange
#                 elif match_sim >= 25:
#                     source_color = colors.HexColor('#FFF9C4')  # Light yellow
#                 else:
#                     source_color = colors.HexColor('#C8E6C9')  # Light green
...
#                 # Source box with background color
